package com.jwn.moviedirectory.Model;
...
public class Movie implements Serializable {
    ...
    private String title, director, year, runTime,
                   imdbId, poster, genre, writer,
                   actors, plot, rating, dvdRelease,
                   productionCompany, country, awards,
                   tvRated, movieType;
